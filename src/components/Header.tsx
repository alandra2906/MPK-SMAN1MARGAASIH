      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline text-slate-400 text-[13px] font-mono-data font-semibold uppercase tracking-wider translate-y-[2px]">
              Laman MPK SMAN 1 Margaasih
            </span>
          </Link>
